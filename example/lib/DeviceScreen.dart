...
class DeviceScreen extends StatelessWidget {
  ...
  ServiceTile _serviceTile(BluetoothService s) => ServiceTile(
        service: s,
        characteristicTiles: s.characteristics.map((c) => _characteristicTile(c)).toList(),
      );

  CharacteristicTile _characteristicTile(BluetoothCharacteristic c) => CharacteristicTile(
    characteristic: c,
